...
abstract class EndlessRecyclerViewScrollListener(private var visibleThreshold: Int = 5) :
    ...
    constructor(visibleThreshold: Int = 5, layoutManager: LinearLayoutManager) : this(
        visibleThreshold
    ) {
    ...
    constructor(visibleThreshold: Int = 5, layoutManager: StaggeredGridLayoutManager) : this(
        visibleThreshold
    ) {
        this.mLayoutManager = layoutManager
        this.visibleThreshold = visibleThreshold * layoutManager.spanCount
    ...
    override fun onScrolled(view: RecyclerView, dx: Int, dy: Int) {
        ...
        if (!loading && lastVisibleItemPosition + visibleThreshold > totalItemCount && totalItemCount >= visibleThreshold - 2) {
            currentPage++
