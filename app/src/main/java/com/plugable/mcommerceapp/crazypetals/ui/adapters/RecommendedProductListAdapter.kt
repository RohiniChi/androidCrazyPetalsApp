...
import com.plugable.mcommerceapp.crazypetals.utils.validation.strikeThroughText
import kotlinx.android.synthetic.main.layout_recommanded_product_item.view.*
import java.util.*

/**
 * [RecommandedProductListAdapter] is an adapter used to load list of products in recycler view
 *
 ...
 */
class RecommendedProductListAdapter : RecyclerView.Adapter<RecommendedProductListAdapter.MyViewHolder> {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, position: Int): MyViewHolder {
        return MyViewHolder(
            LayoutInflater.from(context).inflate(
                R.layout.layout_recommanded_product_item,
                viewGroup,
                false
            )
        )
